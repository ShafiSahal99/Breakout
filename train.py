...
# -*- coding: utf-8 -*-
"""
Created on Wed May 19 15:09:06 2021
...
def train(rank, params, shared_model, optimizer):
    ...
    model = ActorCritic(env_observation_space.shape[0], env.action_space)
    state = env.reset()
    state = torch.from_numpy_array(state)
    done = True
    episode_length = 0
    while True:
        episode_length += 1
